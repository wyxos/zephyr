...
function normalizeMainOptions(firstArg = null, secondArg = null) {
    if (firstArg && typeof firstArg === 'object' && !Array.isArray(firstArg)) {
        return {
            ...
            frontendBuildStrategy: firstArg.frontendBuildStrategy ?? null,
            ...
            explicitFrontendBuildStrategy: resolveExplicitOption(
                firstArg,
                'explicitFrontendBuildStrategy',
...
async function main(optionsOrWorkflowType = null, versionArg = null) {
    ...
    const executionMode = {
        ...
        frontendBuildStrategy: options.frontendBuildStrategy,
        ...
        explicitFrontendBuildStrategy: options.explicitFrontendBuildStrategy === true,
        ...
        if (currentExecutionMode.json) {
            emitEvent?.('run_started', {
                ...
                data: {
                    ...
                    frontendBuildStrategy: currentExecutionMode.frontendBuildStrategy,
